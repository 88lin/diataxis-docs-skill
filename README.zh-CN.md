...
前 5 行（Tutorial、How-to、Reference、Explanation、Quickstart）是 Diataxis 核心 4 形；后 4 行（README、Troubleshooting、Glossary、Release notes）是从 Good Docs Project 模板映射过来的邻近类型，详见 [`references/template-map.md`](references/template-map.md)。
